...
lodash.prototype.at=seq.at;lodash.prototype.chain=seq.wrapperChain;lodash.prototype.commit=seq.commit;lodash.prototype.next=seq.next;lodash.prototype.plant=seq.plant;lodash.prototype.reverse=seq.reverse;lodash.prototype.toJSON=lodash.prototype.valueOf=lodash.prototype.value=seq.value;lodash.prototype.first=lodash.prototype.head;if(symIterator$1){lodash.prototype[symIterator$1]=seq.toIterator}var classCallCheck=function(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function")}};var createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor}}();var PARSE_CONFIG={header:true};var TranslationTransformator=function(){function TranslationTransformator($http,$q){classCallCheck(this,TranslationTransformator);this.__$http=$http;this.__$q=$q}createClass(TranslationTransformator,[{key:"transform",value:function transform$$1(){this.__$q.all([this.__buildReferenceModel(),this.__parseFile()]).then(function(results){console.log(results)})}},{key:"__parseFile",value:function __parseFile(){var _this=this;return this.__$q(function(resolve,reject$$1){if(_this.fileHandle.get(0).files.length>0){papaparse.parse(_this.fileHandle.get(0).files[0],defaults({complete:resolve},PARSE_CONFIG))}else{reject$$1()}})}},{key:"__buildReferenceModel",value:function __buildReferenceModel(){var _this2=this;return this.__$q(function(resolve,reject$$1){_this2.__$http({method:"GET",url:_this2.url}).then(function(response){resolve(_this2.__traverseJSON(response.data))})})}},{key:"__traverseJSON",value:function __traverseJSON(json){var _this3=this;var prefix=arguments.length>1&&arguments[1]!==undefined?arguments[1]:"";var obj={};forEach(json,function(value$$1,key){var prefixKey=prefix?prefix+"."+key:key;if(!isObject$1(value$$1)){obj[prefixKey]=value$$1}else{assign$1(obj,_this3.__traverseJSON(value$$1,prefixKey))}});return obj}}]);return TranslationTransformator}();TranslationTransformator.$inject=["$http","$q"];angular.module("csv2json",[]).component("csvTwoJson",{controller:TranslationTransformator,controllerAs:"transform",templateUrl:"csv2Json.html"})})();
...
(function (root, factory) {
    if ('object' === 'object' && typeof exports.nodeName !== 'string') {
...
}(window || commonjsGlobal, function (window, noGlobal) {
        "use strict";
        ...
        if (typeof undefined === "function" && undefined.amd) {
            undefined("file-saverjs", [], function () {
                return saveAs;
            });
        }
...
var invoke$1 = baseRest(baseInvoke);
...
function isSafeInteger(value) {
  return isInteger$1(value) && value >= -MAX_SAFE_INTEGER$2 && value <= MAX_SAFE_INTEGER$2;
}
...
function parseInt$1(string, radix, guard) {
  ...
  return nativeParseInt(toString$2(string).replace(reTrimStart, ''), radix || 0);
}
 ...
 * // => 'hi fred'
 */
var partial$1 = baseRest(function(func, partials) {
  var holders = replaceHolders(partials, getHolder(partial$1));
...
function repeat$1(string, n, guard) {
  ...
  return baseRepeat(toString$2(string), n);
}
...
function toPath(value) {
  ...
  return isSymbol$1(value) ? [value] : copyArray(stringToPath(toString$2(value)));
}
...
var func = {
  ...
  partial: partial$1, partialRight, rearg, rest, spread,
  throttle, unary, wrap: wrap$2
};
...
var lang = {
  ...
  isEqualWith, isError, isFinite: isFinite$1, isFunction, isInteger: isInteger$1,
  isLength, isMap, isMatch, isMatchWith, isNaN: isNaN$1,
  isNative, isNil, isNull, isNumber, isObject: isObject$1,
  isObjectLike, isPlainObject, isRegExp: isRegExp$1, isSafeInteger, isSet,
  isString, isSymbol: isSymbol$1, isTypedArray, isUndefined, isWeakMap,
  isWeakSet, lt, lte, toArray, toFinite,
  toInteger, toLength: toLength$1, toNumber: toNumber$1, toPlainObject, toSafeInteger,
  toString: toString$2
};

var math = {
  add, ceil: ceil$1, divide: divide$1, floor: floor$3, max: max$1,
  maxBy, mean, meanBy, min: min$2, minBy,
  multiply: multiply$1, round, subtract, sum, sumBy
};
...
var object = {
  assign: assign$1, assignIn, assignInWith, assignWith, at,
  ...
  get: get$1, has: has$1, hasIn, invert, invertBy,
  invoke: invoke$1, keys: keys$2, keysIn: keysIn$1, mapKeys, mapValues,
...
var string = {
  ...
  templateSettings, toLower, toUpper, trim: trim$1, trimEnd,
...
var TranslationTransformator = function () {
    function TranslationTransformator() {
        var _this = this;

        classCallCheck(this, TranslationTransformator);

        // set up bindings
        this.fileHandle = jquery$1('#locale-csv');
        this.url = jquery$1('#local-json-base-path');

        jquery$1('#transform-trigger').on('click', function (event) {
            _this.transform(event);
        });
    }

    createClass(TranslationTransformator, [{
        key: 'transform',
        value: function transform$$1(event) {
            if (event) {
                event.preventDefault();
            }

            Promise.all([this.__buildReferenceModel(), this.__parseFile()]).then(function (results) {
                console.log(results);
            });
        }
    }, {
        key: '__parseFile',
        value: function __parseFile() {
            var _this2 = this;

            return new Promise(function (resolve, reject$$1) {
                if (_this2.fileHandle.get(0).files.length > 0) {
                    papaparse.parse(_this2.fileHandle.get(0).files[0], defaults({
                        complete: resolve
                    }, PARSE_CONFIG));
                } else {
                    reject$$1();
        ...
        key: '__buildReferenceModel',
        value: function __buildReferenceModel() {
            var _this3 = this;

            return new Promise(function (resolve, reject$$1) {
                jquery$1.getJSON(_this3.url.val(), function (data) {
                    resolve(_this3.__traverseJSON(data));
                });
            });
        }
    }, {
        key: '__traverseJSON',
        value: function __traverseJSON(json) {
            var _this4 = this;

            var prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';

            var obj = {};
            forEach(json, function (value$$1, key) {
                var prefixKey = prefix ? prefix + '.' + key : key;
                if (!isObject$1(value$$1)) {
                    obj[prefixKey] = value$$1;
                } else {
                    assign$1(obj, _this4.__traverseJSON(value$$1, prefixKey));
                }
            });
            return obj;
        }
